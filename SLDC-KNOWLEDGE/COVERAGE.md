...
| Data / ML | verified representative | `language-domain-matrix.md`, `domain-expansion-2026-08.md`, `ml-data-feature-orchestration.md`, `data-versioning-lineage.md`, `ml-monitoring-retraining-governance.md` | PyTorch profiling; MLflow tracking/registry/evaluation; TFDV data validation; Feast feature-store semantics; Kubeflow Pipelines/Airflow orchestration; DVC/lakeFS versioned data states; OpenLineage run/job/dataset lineage; production monitoring and governed retraining/promotion boundaries |
...
| Additional ML lifecycle systems | verified representative | `domain-expansion-2026-08.md`, `ml-data-feature-orchestration.md`, `data-versioning-lineage.md`, `ml-monitoring-retraining-governance.md` | MLflow 3.14.0 tracking/registry/evaluation plus TFDV, Feast, KFP/Airflow, DVC/lakeFS/OpenLineage and cross-vendor production monitoring/retraining-governance evidence |
...
- independent ML data-validation systems, feature-store alternatives, stream-first processing/orchestration, independent data-versioning systems, Iceberg/Delta/Hudi snapshot semantics, column/transformation-level lineage completeness, feature freshness/availability SLOs, data labeling/human feedback, delayed/sparse-label monitoring, drift-to-business-impact causality, quantitative monitoring-window/sample-size policy, cross-vendor metric semantics, independent monitoring systems, and governed promotion/retraining patterns beyond the verified representatives;
