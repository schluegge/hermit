...
| Immutable / transactional Linux OS updates | verified representative | `immutable-transactional-linux-os.md` | rpm-ostree offline deployments/rollback, bootc OCI OS-image update/recovery boundaries, and NixOS build/activate/generation rollback and retention semantics |
