...
| AI-driven automation | complete | `ai-sdlc.md`, `ai-ops-memory-context.md`, `agent-protocols.md`, `ml-data-feature-orchestration.md`, `data-versioning-lineage.md`, `lakehouse-table-history.md`, `ml-monitoring-retraining-governance.md`, `performance-profiling-tracing.md`, `performance-platform-ci.md`, `gpu-vendor-profiling.md`, `supply-chain-security-fuzzing.md`, `application-security-sbom-policy.md`, `vulnerability-intelligence-sbom-consumers.md`, `container-iac-cloud-mobile-security.md`, `release-deployment-progressive-delivery.md`, `release-safety-flags-database-nonk8s.md`, `zero-downtime-database-evolution.md`, `database-backfill-cdc.md`, `store-and-fleet-release-safety.md`, `firmware-anti-rollback-automotive.md`, `slo-error-budget-release-gates.md`, `desktop-update-security.md`, `linux-desktop-updates.md`, `distribution-linux-package-management.md`, `immutable-transactional-linux-os.md`, `ubuntu-core-update-governance.md` | Finite baseline has definition, lifecycle role, representative verified classes, selection, integration and automation possibilities; open-ended capability discovery explicitly remains non-exhaustive |
...
| Embedded / HIL | verified representative | `language-domain-matrix.md`, `domain-expansion-2026-08.md`, `firmware-anti-rollback-automotive.md` | Zephyr west/Twister plus ESP-IDF build/flash/monitor/on-target testing and firmware security-counter/boot-recovery evidence |
| Data / ML | verified representative | `language-domain-matrix.md`, `domain-expansion-2026-08.md`, `ml-data-feature-orchestration.md`, `data-versioning-lineage.md`, `lakehouse-table-history.md`, `ml-monitoring-retraining-governance.md` | PyTorch profiling; MLflow tracking/registry/evaluation; TFDV validation; Feast feature-store semantics; KFP/Airflow orchestration; DVC/lakeFS/OpenLineage versioning/lineage; Iceberg/Delta/Hudi transactional table history and retention; production monitoring and governed retraining |
...
| Data versioning / lineage | verified representative | `data-versioning-lineage.md` | DVC 3.67.1 Git-linked artifact/data revisions, lakeFS 1.84.1 branch/commit/merge/revert semantics, OpenLineage 1.52.0 Dataset/Job/Run lineage events and explicit versioning-versus-lineage boundaries |
| Lakehouse table history / time travel / retention | verified representative | `lakehouse-table-history.md` | Iceberg 1.11.0 snapshots/branches/tags/WAP; Delta Lake 4.3.1 version/timestamp time travel and VACUUM retention boundaries; Hudi 1.2.0 timeline/time travel/incremental/CDC and cleaner/archival separation |
...
| Additional ML lifecycle systems | verified representative | `domain-expansion-2026-08.md`, `ml-data-feature-orchestration.md`, `data-versioning-lineage.md`, `lakehouse-table-history.md`, `ml-monitoring-retraining-governance.md` | MLflow 3.14.0, TFDV, Feast, KFP/Airflow, DVC/lakeFS/OpenLineage, Iceberg/Delta/Hudi history semantics, and cross-vendor production monitoring/retraining-governance evidence |
| Vendor-specific embedded stacks | verified representative | `domain-expansion-2026-08.md`, `firmware-anti-rollback-automotive.md` | ESP-IDF adds vendor-specific build/flash/monitor/debug/on-target-test plus current ESP32 eFuse anti-rollback/security-version evidence |
| Firmware anti-rollback / automotive update security | verified representative | `firmware-anti-rollback-automotive.md` | MCUboot 2.4.0 test-swap recovery plus software/hardware downgrade prevention, ESP-IDF eFuse security-version floor, Uptane 2.1.0 automotive rollback/freeze/mix-and-match defenses and exceptional rollback governance |
...
| Vulnerability intelligence / SBOM consumers | verified representative | `vulnerability-intelligence-sbom-consumers.md` | OSV schema 1.9.0 and API aggregation, OSV-Scanner 2.4.0 direct source/image/SBOM analysis, Dependency-Track v5 portfolio SBOM analysis/source routing/policy gating, and explicit inventory/matching/triage boundaries |
...
| Linux desktop update channels / self-update | verified representative | `linux-desktop-updates.md` | Flatpak repository/update/commit-downgrade/mask semantics; Snap automatic refresh/hold/revert/hooks/transaction boundaries; AppImage decentralized update information, signatures and maintainer-stated AppImageUpdate beta caveat |
| Distribution-native Linux package management | verified representative | `distribution-linux-package-management.md` | APT repository authentication/hold/upgrade semantics; DNF5/RPM transaction history, offline, signature and verification planes; SUSE Zypper/Snapper snapshot recovery boundaries; Pacman 7.1 sync/downgrade/signature/cache/config-file semantics |
| Immutable / transactional Linux OS updates | verified representative | `immutable-transactional-linux-os.md`, `ubuntu-core-update-governance.md` | rpm-ostree offline deployments/rollback, bootc OCI OS-image update/recovery boundaries, NixOS generations, plus Ubuntu Core 26 snap-based automatic refresh, validation-set governance, essential-snap boot verification and recovery-system boundaries |
...
- independent ML data-validation systems, feature-store alternatives, stream-first processing/orchestration, independent data-versioning systems, deeper Iceberg/Delta/Hudi cross-engine compatibility and CDC/change-feed comparisons, column/transformation-level lineage completeness, feature freshness/availability SLOs, data labeling/human feedback, delayed/sparse-label monitoring, drift-to-business-impact causality, quantitative monitoring-window/sample-size policy, cross-vendor metric semantics, independent monitoring systems, and governed promotion/retraining patterns beyond the verified representatives;
- additional MCU/FPGA/automotive and vendor-specific embedded ecosystems beyond the current Zephyr/ESP-IDF/MCUboot/Uptane representatives, including power-loss/fault-injection behavior, peripheral/co-processor coordination, additional SoC anti-rollback implementations, and production automotive conformance evidence;
- additional independent SBOM consumers, vulnerability databases/advisory systems, normalized cross-source false-positive/false-negative evidence, vulnerability-data freshness SLOs, and cross-tool VEX/exploitability/reachability semantics beyond the verified OSV/OSV-Scanner/Dependency-Track representatives;
...
- additional desktop updater frameworks, Windows MSI/EXE updater paths, additional distribution-native Linux package-management evidence beyond the verified APT/DNF5/Zypper/Pacman representatives, additional transactional/image-based OS implementations beyond rpm-ostree/bootc/NixOS/Ubuntu Core, first-class automatic post-install rollback/health recovery, additional independent OTA/fleet systems, additional feature-flag implementations, and database-evolution evidence for quantitative lock/resource/lag budgets, replication/failover during schema evolution, CDC-assisted cutover/reconciliation, and additional engines beyond PostgreSQL/MySQL/SQL Server/Oracle;
...
- app-store/fleet/desktop/OS promotion automation that directly consumes crash/SLO/update-health evidence for promotion decisions;
- further evidence-backed AI security/fuzzing/performance/release/deployment/incident/database/ML/data-lineage/OS-update/firmware-update automation, with generated outputs kept behind deterministic verification and explicit authority boundaries.
