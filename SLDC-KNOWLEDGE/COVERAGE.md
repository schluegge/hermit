...
| Data / ML | verified representative | `language-domain-matrix.md`, `domain-expansion-2026-08.md`, `ml-data-feature-orchestration.md` | PyTorch profiling; MLflow tracking/registry/evaluation; TFDV data validation; Feast feature-store semantics; Kubeflow Pipelines/Airflow orchestration |
...
| Additional ML lifecycle systems | verified representative | `domain-expansion-2026-08.md`, `ml-data-feature-orchestration.md` | MLflow 3.14.0 tracking/registry/evaluation plus TFDV, Feast and KFP/Airflow data/feature/orchestration evidence |
...
- independent ML data-validation systems, feature-store alternatives, stream-first processing/orchestration, dataset lineage/versioning, feature freshness/availability SLOs, data labeling/human feedback, and model-monitoring/retraining governance;
